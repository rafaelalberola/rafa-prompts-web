...
**Ahora**: el flow se llama LUNA, palabra clave `luna`, landing `/luna.html`.

```
https://rafaprompts.com/luna.html
```
...
3. En el nodo que manda el enlace de la guía, cambiar la URL `https://rafaprompts.com/yate.html` por `https://rafaprompts.com/luna.html`
4. Testear desde un móvil comentando `luna` en el reel YATE_LUNAR
5. Debe llegar el DM con el botón, y al pulsarlo abrir `rafaprompts.com/luna.html`
...
- [ ] Redirect `/yate.html → /luna.html` funcionando (para enlaces antiguos)
